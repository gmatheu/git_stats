...
")
      ...
      it 'should parse git revlist output to date sorted commits array' do
        repo_tree.should_receive(:run).
          with("git rev-list --pretty=format:'%h|%at|%ai|%aE|%s' HEAD ./subdir_with_1_commit | grep -ve '^commit'").
          and_return("10d1814|1395407506|2014-03-21 14:11:46 +0100|israelrevert@gmail.com|message")
